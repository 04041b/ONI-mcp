...
public class StatusItemGroup
{
  ...
  private static Func<List<Notification>, object, string> OnToolTip = (Func<List<Notification>, object, string>) ((notifications, data) => ((StatusItem) data).notificationTooltipText + notifications.ReduceMessages());
  ...
  public Guid AddStatusItem(StatusItem item, object data = null, StatusItemCategory category = null)
  {
    ...
    {
      entry1.notification = new Notification(item.notificationText, item.notificationType, StatusItemGroup.OnToolTip, (object) item, false, custom_click_callback: item.notificationClickCallback, custom_click_data: data);
