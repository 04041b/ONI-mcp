...
public class MISC
{
  public class TAGS
  {
    ...
    public static LocString CROPSEED = (LocString) "Crop Seed";
    public static LocString WATERSEED = (LocString) "Aquatic Seed";
    public static LocString DECORSEED = (LocString) "Decor Seed";
    ...
    public static LocString SLIPPERY = (LocString) UI.FormatAsLink("Slippery", nameof (SLIPPERY));
    public static LocString SLIPPERY_DESC = (LocString) $"Some {UI.FormatAsLink("liquids", "ELEMENTS_LIQUID")} and {UI.FormatAsLink("solids", "ELEMENTS_SOLID")} have a remarkably low coefficient of friction. These present a safety hazard if left on the ground, as Duplicants may slip and fall when traveling across them.";
    ...
    public static LocString ORGANICS_DESC = (LocString) $"Organic materials are useful ingredients gathered from the environment, harvested from {UI.FormatAsLink("plants", "PLANTS")} or derived from {UI.FormatAsLink("critters", "CREATURES")}.\n\nSome, not all, require additional processing before they can be used.";
    public static LocString CONSUMABLEORE = (LocString) "Consumable Ore";
    public static LocString SUBLIMATING = (LocString) UI.FormatAsLink("Sublimator", "SUBLIMATES");
    ...
    public static LocString TECHCOMPONENTS = (LocString) UI.FormatAsLink("Tech Component", nameof (TECHCOMPONENTS));
    public static LocString ORNAMENT = (LocString) UI.FormatAsLink("Ornament", nameof (ORNAMENT));
    ...
    public static LocString ORNAMENTDISPLAYED = (LocString) "Ornament";
    public static LocString PEDESTALDISPLAYABLE = (LocString) "Other Pedestal Displayable";
    ...
    public static LocString ARTIFACT = (LocString) "Artifact";
    ...
    public static LocString LONGRANGEMISSILE = (LocString) "Long Range Missile";
  }
  ...
  public class STATUSITEMS
  {
    ...
    {
      public static LocString NAME = (LocString) "{0}";
      public static LocString TOOLTIP = (LocString) "{0}";
    }
  ...
  public class NOTIFICATIONS
  {
    ...
    public class LOTS_OF_GERMS
    {
      ...
      public static LocString MESSAGEBODY = (LocString) $"{UI.FormatAsLink("Germs", "DISEASE")} such as {(string) DUPLICANTS.DISEASES.FOODPOISONING.NAME} and {(string) DUPLICANTS.DISEASES.SLIMELUNG.NAME} can cause {UI.FormatAsLink("Disease", "DISEASE")} in my Duplicants. I can use the {UI.FormatAsOverlay("Germ Overlay", Action.Overlay9)} to view all germ concentrations in my colony, and even detect the sources spawning them.\n\nBuilding Wash Basins from the {UI.FormatAsBuildMenuTab("Medicine Tab", Action.Plan8)} near colony toilets will tell my Duplicants they need to wash up.\n\nRelated {UI.FormatAsLink("Video: Plumbing and Ventilation", "VIDEOS18")}";
    }
    ...
    public class LEVELUP
    {
      ...
      public static LocString SUFFIX = (LocString) " - {0} Attribute Level modifier raised to +{1}";
    }
    ...
    {
      public static LocString NAME = (LocString) "Artifact found";
      public static LocString TOOLTIP = (LocString) "An artifact has been found in Demolior's rubble";
    }
