...
public class CODEX
{
  ...
  public class STORY_TRAITS
  {
    ...
    public class CRITTER_MANIPULATOR
    {
      ...
      public class SPECIES_ENTRIES
      {
        ...
        public static LocString DIVERGENT = (LocString) "Specimen responded gently to the probative apparatus, as though being careful not to cause any damage.\n\nReview data for more information.";
        ...
        public static LocString BELLY = (LocString) "Specimen produced substantial stool sample. Review data for more information.";
        public static LocString SEAL = (LocString) "Specimen scanned. Review data for more information.";
        public static LocString DEER = (LocString) "This critter seemed amused by the scanning process. Review data for more information.";
      ...
      public class SPECIES_ENTRIES_EXPANDED
      {
        ...
        public static LocString DEER = (LocString) "This critter's perpetual grin grew as it observed each step of the process extremely closely.\n\nBehavioral analysis indicates a tendency toward mischief. Close supervision - and minimal access to advanced machinery - is recommended.";
        public static LocString RAPTOR = (LocString) "This critter's x-ray imaging indicates that its cranial protrusion may not be a horn at all.\n\nIt is not composed of live bone surrounded by a keratin-and-protein shell, but rather an ennervated, calcified structure. An illogically located tooth, or perhaps a rostrum?\n\nFascinating.";
        public static LocString STEGO = (LocString) "This critter was temporarily stuck in the scanning area due to its size. It appeared to enjoy being shoved backward and forward on the conveyor belt during dislodgment.\n\nUpon finally reaching the exit, the critter seemed confused as to why the ride was over.";
        public static LocString MOSQUITO = (LocString) "On the surface of this critter's wings are thousands of microperforations. These appear to act as acoustic liners, allowing the Gnit to approach targets without the high-pitched whine of its wingbeats giving away its position.";
        ...
        public static LocString PREHISTORICPACU = (LocString) "This critter attacked the transducer.\n\nWhen the swallowed component was regurgitated, it was coated in microorganisms that predate this colony by at least several millenia.\n\nUnfortunately, it was reingested before analysis was completed.";
        public static LocString UNKNOWN_TITLE = (LocString) "Non-Fluxable Species";
        public static LocString UNKNOWN = (LocString) "MESSAGE FROM THE MANUFACTURER: Subject successfully scanned.\n\nFlux function unavailable due to genome-parsing malfunction.\n\nPlease note that kicking the building's exterior is unlikely to correct this issue and may result in permanent damage to the system.";
      }
  ...
  public class HEADERS
  {
    ...
    public static LocString DISPLAYABLEITEMS = (LocString) "Displayable Items";
  ...
  public class FORMAT_STRINGS
  {
    ...
    public static LocString SUBLIMATION_NAME = (LocString) "Sublimation";
    public static LocString OFFGASS_NAME = (LocString) "Off-Gas";
    public static LocString SUBLIMATION_TRESHOLD = (LocString) "Surrounding pressure under {0}";
    public static LocString OFFGASS_TRESHOLD = (LocString) "Surrounding pressure under {0}";
  ...
  public class MISC
  {
    public class TIP_ICON
    {
      ...
      {
        public static LocString TOOLTIP = (LocString) $"Skill Required\n\nDuplicants must possess the {(string) DUPLICANTS.ROLES.SENIOR_FARMER.NAME} skill to salvage {(string) ITEMS.INDUSTRIAL_PRODUCTS.PLANT_FIBER.NAME} during harvest";
      }
    }
  }
  ...
  public class CATEGORIES
  {
    public class SHARED
    {
      ...
      public static LocString LIST_TITLE = (LocString) "In this category:";
    }
  ...
  public class ROOM_REQUIREMENT_CLASS
  {
    ...
    public class SHARED
    {
      public static LocString BUILDINGS_LIST_TITLE = (LocString) "In this category:";
    ...
    {
      public static LocString TITLE = (LocString) UI.FormatAsLink("Decor Buildings", nameof (DECORATION));
    ...
    {
      public static LocString TITLE = (LocString) UI.FormatAsLink("Displayed Ornaments", "ORNAMENTDISPLAYED");
      public static LocString DESCRIPTION = (LocString) $"Ornaments are items with exceptionally high {UI.FormatAsLink("Decor", "DECOR")}, and must be displayed on a {(string) BUILDINGS.PREFABS.ITEMPEDESTAL.NAME} or {(string) BUILDINGS.PREFABS.SHELF.NAME} in order to be counted toward a room's requirements.\n\nThey can be obtained through exploration, excavation, and study. Some are admired in their original form, while others can be reworked or crafted by {UI.FormatAsLink("creative", "ARTING1")} Duplicants.";
      public static LocString FLAVOUR = (LocString) "";
      public static LocString ROOMSREQUIRING = (LocString) ("    • " + UI.FormatAsLink("Banquet Hall", "BANQUETHALL"));
    }

    public class RANCHSTATIONTYPE
    {
      public static LocString TITLE = (LocString) UI.FormatAsLink("Ranching Buildings", nameof (RANCHSTATIONTYPE));
    ...
    {
      public static LocString TITLE = (LocString) UI.FormatAsLink("Beds", nameof (BEDTYPE));
    ...
    {
      public static LocString TITLE = (LocString) UI.FormatAsLink("Light Sources", nameof (LIGHTSOURCE));
    ...
    {
      public static LocString TITLE = (LocString) UI.FormatAsLink("Rocket Interior", nameof (ROCKETINTERIOR));
    ...
    {
      public static LocString TITLE = (LocString) UI.FormatAsLink("Cooking Stations", nameof (COOKTOP));
    ...
    {
      public static LocString TITLE = (LocString) UI.FormatAsLink("Warming Stations", nameof (WARMINGSTATION));
    ...
    {
      public static LocString TITLE = (LocString) UI.FormatAsLink("Generators", nameof (GENERATORTYPE));
    ...
    {
      public static LocString TITLE = (LocString) UI.FormatAsLink("Power Buildings", nameof (POWERBUILDING));
    ...
    {
      public static LocString TITLE = (LocString) "Dining Tables";
      public static LocString DESCRIPTION = (LocString) "Buildings that enable Duplicants to enjoy their meals at a dignified distance from the floor.";
      public static LocString FLAVOUR = (LocString) "";
      public static LocString CONFLICTINGROOMS = (LocString) $"    • {UI.FormatAsLink("Banquet Hall", "GREATERHALL")} (No Mess Table)\n";
      public static LocString ROOMSREQUIRING = (LocString) $"    • {UI.FormatAsLink("Mess Hall", "MESSHALL")}\n    • {UI.FormatAsLink("Great Hall", "GREATHALL")}\n    • {UI.FormatAsLink("Banquet Hall", "GREATERHALL")} (Communal Table)";
    }
  }
  ...
  {
    public static LocString SPECIES_TITLE = (LocString) "Moos";
    public static LocString SPECIES_SUBTITLE = (LocString) "Critter Species";
    ...
    public class BODY
    {
      public static LocString CONTAINER1 = (LocString) "Little is currently known of the Moo due to its alien nature and origin.\n\nIt is capable of surviving in zero gravity conditions and no atmosphere, and its method of reproduction has yet to be discovered.";
      public static LocString CONTAINER2 = (LocString) "The Moo has an even temperament and cohabits well with others in a farm setting.";
    }
  }

  public class DIESELMOO
  {
    public static LocString TITLE = (LocString) "Husky Moo";
    public static LocString SUBTITLE = (LocString) "Critter Morph";

    public class BODY
    {
      public static LocString CONTAINER1 = (LocString) "<smallcaps>Pictured: \"Husky\" Moo variant</smallcaps>";
    }
  }
  ...
  {
    public static LocString CODEXCATEGORYNAME = (LocString) "Duplicants";
    public static LocString SPECIES_TITLE = (LocString) "Duplicant Types";
  ...
  public class ORNAMENT
  {
    public static LocString TITLE = (LocString) "Ornaments";
    public static LocString SUBTITLE = (LocString) "Collectible Display Items";

    public class BODY
    {
      public static LocString CONTAINER1 = (LocString) $"Ornaments are decorative objects with which Duplicants enjoy sprucing up their colonies. They tend to be smaller than traditional artwork, and possess very high {UI.FormatAsLink("Decor", "DECOR")} value.\n\n{UI.FormatAsLink("Displayed Ornaments", "REQUIREMENTCLASSORNAMENT")} exhibited atop a {(string) BUILDINGS.PREFABS.ITEMPEDESTAL.NAME} or {(string) BUILDINGS.PREFABS.SHELF.NAME} allow a colony to benefit from certain {UI.FormatAsLink("Room", "ROOMS")} bonuses.\n\n";
    }
  }

  public class FOUNDOBJECT
  {
    public static LocString TITLE = (LocString) "Found Objects ";

    public class BODY
    {
      public static LocString CONTAINER1 = (LocString) "In the course of everyday colony expansion and biome excavation, my Duplicants may uncover aesthetically pleasing displayable objects.\n\n";
    }
  }

  public class KEEPSAKE
  {
    public static LocString TITLE = (LocString) "Keepsakes";

    public class BODY
    {
      public static LocString CONTAINER1 = (LocString) "In the aftermath of a successful mission--be it the completion of a story trait or the survival of some epic event--my Duplicants sometimes form sentimental attachments to an item associated with that chapter of their lives.\n\n";
    }
  }

  public class SPACEARTIFACT
  {
    public static LocString TITLE = (LocString) "Space Artifacts";

    public class BODY
    {
      public static LocString CONTAINER1 = (LocString) $"While out harvesting resources from space POIs, miners may discover rare artifacts that pique their interest.\n\nThese can be gathered and transported back to the colony using a rocket equipped with an {(string) BUILDINGS.PREFABS.ARTIFACTCARGOBAY.NAME}.";
    }
  }
  ...
  public class LILYPAD
  {
    ...
    public class BODY
    {
      public static LocString CONTAINER1 = (LocString) "Cura Lotuses are adaptable aquatic plants that have inspired artists since their blossoms were first spotted bobbing on the surface of a quiet pond.\n\nThese ethereal beauties are a panacea for both the mind and the body - their delicate spores are highly sought-after for their natural antihistamine properties.";
    }
  }
  ...
  public class DECORSYSTEM
  {
    ...
    public static LocString HEADER_3 = (LocString) "Tutorials";
    public static LocString PARAGRAPH_3 = (LocString) $"To learn more, watch {UI.FormatAsLink("Video: Duplicant Morale", "VIDEOS13")} and see {UI.FormatAsLink("Tutorial: Stress Management", "MISCELLANEOUSTIPS2")}.\n\n";
  }
  ...
  public class EXOBASES
  {
    ...
    public static LocString PARAGRAPH_2 = (LocString) $"To scan space and see nearby intersteller destinations a {UI.FormatAsLink("Telescope", "CLUSTERTELESCOPE")} must first be built on the surface of a Planetoid. {UI.FormatAsLink("Orbital Data Collection Lab", "ORBITALRESEARCHCENTER")} in orbit around a Planetoid, and {UI.FormatAsLink("Cartographic Module", "SCANNERMODULE")} attached to a rocket can also reveal places on a Starmap.\n\nAlways check engine fuel to determine if your rocket can reach its destination, keeping in mind rockets can only land on Planetoids with a {UI.FormatAsLink("Rocket Platform", "LAUNCHPAD")} on it although some modules like {UI.FormatAsLink("Rover's Modules", "SCOUTMODULE")} and {UI.FormatAsLink("Trailblazer Modules", "PIONEERMODULE")} can be sent to the surface of a Planetoid from a rocket in orbit.\n\n";
    public static LocString HEADER_3 = (LocString) "Space Transport";
    public static LocString PARAGRAPH_3 = (LocString) $"Goods can be teleported between worlds with connected Supply Teleporters through {UI.FormatAsLink("Gas", "ELEMENTS_GAS")}, {UI.FormatAsLink("Liquid", "ELEMENTS_LIQUID")}, and {UI.FormatAsLink("Solid", "ELEMENTS_SOLID")} conduits.\n\nPlanetoids not connected through Supply Teleporters can use rockets to transport goods, either by landing on a {UI.FormatAsLink("Rocket Platform", "LAUNCHPAD")} or a {UI.FormatAsLink("Orbital Cargo Module", "ORBITALCARGOMODULE")} deployed from a rocket in orbit.\n\nAdditionally, the {UI.FormatAsLink("Interplanetary Launcher", "RAILGUN")} can send {UI.FormatAsLink("Interplanetary Payloads", "RAILGUNPAYLOAD")} full of goods through space but must be opened by a {UI.FormatAsLink("Payload Opener", "RAILGUNPAYLOADOPENER")}. A {UI.FormatAsLink("Targeting Beacon", "LANDINGBEACON")} can guide payloads and orbital modules to land at a specific location on a Planetoid surface.";
  }

  public class EXOBASESDLC1
  {
    public static LocString TITLE = (LocString) UI.FormatAsLink("Space Travel", "EXOBASES");
    public static LocString HEADER_1 = (LocString) "Building Rockets";
    public static LocString PARAGRAPH_1 = (LocString) $"Building a rocket first requires constructing a {UI.FormatAsLink("Rocket Platform", "LAUNCHPAD")} and adding modules from the menu. All rockets will require an engine, a nosecone and a Command Module piloted by a Duplicant possessing the {UI.FormatAsLink("Rocket Piloting", "ROCKETPILOTING1")} skill or higher. Note that the {UI.FormatAsLink("Solo Spacefarer Nosecone", "HABITATMODULESMALL")} functions as both a Command Module and a nosecone.\n\n";
    public static LocString HEADER_2 = (LocString) "Space Exploration";
    public static LocString PARAGRAPH_2 = (LocString) $"To scan space and see nearby interstellar destinations a {UI.FormatAsLink("Telescope", "CLUSTERTELESCOPE")} must first be built on the surface of a Planetoid. Sending an {UI.FormatAsLink("Orbital Data Collection Lab", "ORBITALRESEARCHCENTER")} into orbit around a Planetoid, and having a {UI.FormatAsLink("Cartographic Module", "SCANNERMODULE")} attached to a rocket can also reveal places on a Starmap.\n\nAlways check engine fuel to determine if your rocket can reach its destination, keeping in mind that rockets can only land on Planetoids with a {UI.FormatAsLink("Rocket Platform", "LAUNCHPAD")} on it. Notably, some modules, like {UI.FormatAsLink("Rover's Modules", "SCOUTMODULE")} and {UI.FormatAsLink("Trailblazer Modules", "PIONEERMODULE")}, can be sent to the surface of a Planetoid from a rocket in orbit.\n\nIf a rocket runs out of fuel before it reaches a viable landing site, it will become stranded.";
    public static LocString HEADER_3 = (LocString) "Crew Survival";
    public static LocString PARAGRAPH_3 = (LocString) $"Rockets must be stocked with adequate {(string) UI.BUILDCATEGORIES.OXYGEN.NAME} and {(string) UI.CODEX.CATEGORYNAMES.FOOD} to sustain crew members for the entirety of the journey. Shelf-stable rations that do not require refrigeration should be prioritized as onboard space is limited.\n\nSpending extended periods confined to a rocket interior also takes a toll on {UI.FormatAsLink("Morale", "MORALE")}, which can be mitigated by providing a {UI.FormatAsLink("Toilet", "REQUIREMENTCLASSTOILETTYPE")} to prevent messes, choosing higher-{UI.FormatAsLink("Decor", "DECOR")} furnishings, or dividing up the rocket's interior to benefit from {(string) UI.CODEX.CATEGORYNAMES.ROOMS} bonuses.";
    public static LocString HEADER_4 = (LocString) "Space Transport";
    public static LocString PARAGRAPH_4 = (LocString) $"Goods can be teleported between worlds with connected Supply Teleporters through {UI.FormatAsLink("Gas", "ELEMENTS_GAS")}, {UI.FormatAsLink("Liquid", "ELEMENTS_LIQUID")}, and {UI.FormatAsLink("Solid", "ELEMENTS_SOLID")} conduits.\n\nPlanetoids not connected through Supply Teleporters can use rockets to transport goods, either by landing on a {UI.FormatAsLink("Rocket Platform", "LAUNCHPAD")} or a {UI.FormatAsLink("Orbital Cargo Module", "ORBITALCARGOMODULE")} deployed from a rocket in orbit. Additionally, the {UI.FormatAsLink("Interplanetary Launcher", "RAILGUN")} can send {UI.FormatAsLink("Interplanetary Payloads", "RAILGUNPAYLOAD")} full of goods through space but must be opened by a {UI.FormatAsLink("Payload Opener", "RAILGUNPAYLOADOPENER")}. A {UI.FormatAsLink("Targeting Beacon", "LANDINGBEACON")} can guide payloads and orbital modules to land at a specific location on a Planetoid surface.";
    public static LocString HEADER_5 = (LocString) "Space Mining";
    public static LocString PARAGRAPH_5 = (LocString) $"Retrieving resources from space requires mining a target mass using a rocket equipped with a {(string) BUILDINGS.PREFABS.NOSECONEHARVEST.NAME}, then gathering the harvestable fragments with a cargo module designed for those materials. Cargo modules include {(string) BUILDINGS.PREFABS.SOLIDCARGOBAYSMALL.NAME}, {(string) BUILDINGS.PREFABS.LIQUIDCARGOBAYCLUSTER.NAME}, {(string) BUILDINGS.PREFABS.GASCARGOBAYSMALL.NAME}, and more.\n\nFree-floating {UI.FormatAsLink("Space Artifacts", "SPACEARTIFACT")} and {(string) ITEMS.INDUSTRIAL_PRODUCTS.ORBITAL_RESEARCH_DATABANK.NAME}s can be gathered with an {(string) BUILDINGS.PREFABS.ARTIFACTCARGOBAY.NAME} or a {(string) BUILDINGS.PREFABS.RESEARCHCLUSTERMODULE.NAME} respectively, no mining required.";
  }
  ...
  public class GENETICS
  {
    ...
    public static LocString PARAGRAPH_2 = (LocString) $"Once mutated seeds have been analyzed in the {UI.FormatAsLink("Botanical Analyzer", "GENETICANALYSISSTATION")}, they are ready to be planted. Continued exposure to naturally occurring radiation or a {UI.FormatAsLink("Radiation Lamp", "RADIATIONLIGHT")} is necessary to prevent wilting.\n\n";
    public static LocString HEADER_3 = (LocString) "Critter Morphs";
    public static LocString PARAGRAPH_3 = (LocString) $"Variations within a {UI.FormatAsLink("critter", "CREATURES")} species is common, and while they may share some similarities, different members of a species produce different resources and have their own distinct preferences regarding habitats, environmental {UI.FormatAsLink("Temperature", "HEAT")}, and diet.\n\nSee the {UI.FormatAsLink("Field Guide", "CREATURES::GUIDE")} to learn more about caring for critters.";
  }
  ...
  public class HEALTH
  {
    ...
    public static LocString HEADER_4 = (LocString) "Tutorials";
    public static LocString PARAGRAPH_4 = (LocString) $"To learn more about supporting healthy Duplicant function, see:\n    • {UI.FormatAsLink("Tutorial: Food Safety", "MISCELLANEOUSTIPS11")}\n    • {UI.FormatAsLink("Tutorial: Scheduling", "MISCELLANEOUSTIPS14")}\n    • {UI.FormatAsLink("Tutorial: Germs and Disease", "MISCELLANEOUSTIPS10")}\n";
    public static LocString HEADER_5 = (LocString) "Tutorials";
    public static LocString PARAGRAPH_5 = (LocString) $"To learn more about supporting healthy Duplicant function, see:\n    • {UI.FormatAsLink("Tutorial: Food Safety", "MISCELLANEOUSTIPS11")}\n    • {UI.FormatAsLink("Tutorial: Powering Bionics", "MISCELLANEOUSTIPS20")}\n    • {UI.FormatAsLink("Tutorial: Oiling Bionics", "MISCELLANEOUSTIPS23")}\n\n";
  }
  ...
  public class HEAT
  {
    ...
    public static LocString HEADER_6 = (LocString) "Tutorials";
    public static LocString PARAGRAPH_6 = (LocString) $"To learn more, watch {UI.FormatAsLink("Video: Insulation", "VIDEOS17")} and see the {UI.FormatAsLink("Duplicant Temperature", "MISCELLANEOUSTIPS8")} tutorial.\n\n";
  }
  ...
  public class LIGHT
  {
    ...
    public static LocString HEADER_4 = (LocString) "Video: Power Circuits";
    public static LocString PARAGRAPH_4 = (LocString) $"To learn more about how to keep a colony well-lit, watch the {UI.FormatAsLink("Power Circuits", "VIDEOS16")} video tutorial.\n\n";
  }
  ...
  public class MORALE
  {
    ...
    public static LocString HEADER_4 = (LocString) "Tutorials";
    public static LocString PARAGRAPH_4 = (LocString) $"To learn more, watch {UI.FormatAsLink("Video: Duplicant Morale", "VIDEOS13")} and see {UI.FormatAsLink("Tutorial: Stress Management", "MISCELLANEOUSTIPS2")}.\n\n";
  }
  ...
  public class POWER
  {
    ...
    public static LocString HEADER_5 = (LocString) "Video: Power Circuits";
    public static LocString PARAGRAPH_5 = (LocString) $"To learn more, watch the {UI.FormatAsLink("Power Circuits", "VIDEOS16")} video tutorial.\n\n";
  }
  ...
  public class PRIORITY
  {
    ...
    public static LocString HEADER_4 = (LocString) "Tutorial: Errand Priorities";
    public static LocString PARAGRAPH_4 = (LocString) $"To learn more, see {UI.FormatAsLink("Tutorial: Errand Priorities", "MISCELLANEOUSTIPS6")}.";
  }
  ...
  public class RADIATION
  {
    ...
    public static LocString HEADER_4 = (LocString) "Tutorial";
    public static LocString PARAGRAPH_4 = (LocString) $"To learn more, see {UI.FormatAsLink("Tutorial: Radiation", "MISCELLANEOUSTIPS19")}.\n\n";
  }
  ...
  public class STRESS
  {
    ...
    public static LocString HEADER_3 = (LocString) "Tutorials";
    public static LocString PARAGRAPH_3 = (LocString) $"To learn more about managing Duplicants' moods, watch {UI.FormatAsLink("Video: Duplicant Morale", "VIDEOS13")} and see {UI.FormatAsLink("Tutorial: Stress Management", "MISCELLANEOUSTIPS2")}.\n\n";
  }
}
