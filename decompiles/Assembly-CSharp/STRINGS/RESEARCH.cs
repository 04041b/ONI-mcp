...
public class RESEARCH
{
  ...
  public class TECHS
  {
    ...
    {
      public static LocString NAME = (LocString) UI.FormatAsLink("Missiles", nameof (MISSILES));
      public static LocString DESC = (LocString) "Craft explosives and fire them into outer space.";
    }

    public class JETPACKS
    {
      public static LocString NAME = (LocString) UI.FormatAsLink("Personal Flight", nameof (JETPACKS));
      public static LocString DESC = (LocString) "Give Duplicants the gift of a walk-free commute.";
    }
