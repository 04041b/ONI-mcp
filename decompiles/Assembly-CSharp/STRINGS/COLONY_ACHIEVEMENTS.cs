...
public class COLONY_ACHIEVEMENTS
{
  ...
  public class MISC_REQUIREMENTS
  {
    ...
    public static LocString TAME_GASSYMOO_DESCRIPTION = (LocString) "Find and tame a Moo.";
    ...
    public static LocString COOKED_FOOD_DESCRIPTION = (LocString) "Have a Duplicant eat any cooked meal prepared at an eligible cooking station.";
    ...
    public static LocString LAND_ON_ALL_WORLDS_DESCRIPTION = (LocString) "Land Duplicants or rovers on all worlds in the cluster.";
