  ...
  public class SPECIES
  {
    ...
    public class LIGHTBUG
    {
      ...
      public class VARIANT_ORANGE
      {
        ...
        public static LocString DESC = (LocString) $"Sun Bugs emit a soft orange {UI.FormatAsLink("Light", "LIGHT")} in hopes of attracting more of their kind for company.\n\nTheir eggs contain small amounts of {(string) ELEMENTS.NATURALRESIN.NAME} that can be harvested when cracked at the {(string) BUILDINGS.PREFABS.EGGCRACKER.NAME}.";
      ...
      public class VARIANT_PURPLE
      {
        ...
        public static LocString DESC = (LocString) $"Royal Bugs emit a soft purple {UI.FormatAsLink("Light", "LIGHT")} in hopes of attracting more of their kind for company.\n\nTheir eggs contain small amounts of {(string) ELEMENTS.NATURALRESIN.NAME} that can be harvested when cracked at the {(string) BUILDINGS.PREFABS.EGGCRACKER.NAME}.";
      ...
      public class VARIANT_PINK
      {
        ...
        public static LocString DESC = (LocString) $"Coral Bugs emit a soft pink {UI.FormatAsLink("Light", "LIGHT")} in hopes of attracting more of their kind for company.\n\nTheir eggs contain small amounts of {(string) ELEMENTS.NATURALRESIN.NAME} that can be harvested when cracked at the {(string) BUILDINGS.PREFABS.EGGCRACKER.NAME}.";
      ...
      public class VARIANT_BLUE
      {
        ...
        public static LocString DESC = (LocString) $"Azure Bugs emit a soft blue {UI.FormatAsLink("Light", "LIGHT")} in hopes of attracting more of their kind for company.\n\nTheir eggs contain small amounts of {(string) ELEMENTS.NATURALRESIN.NAME} that can be harvested when cracked at the {(string) BUILDINGS.PREFABS.EGGCRACKER.NAME}.";
      ...
      public class VARIANT_CRYSTAL
      {
        ...
        public static LocString DESC = (LocString) $"Radiant Bugs emit an extra-bright {UI.FormatAsLink("Light", "LIGHT")} in hopes of attracting more of their kind for company.\n\nTheir eggs contain small amounts of {(string) ELEMENTS.NATURALRESIN.NAME} that can be harvested when cracked at the {(string) BUILDINGS.PREFABS.EGGCRACKER.NAME}.";
