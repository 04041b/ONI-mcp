...
public class StationaryChoreRangeVisualizer : KMonoBehaviour
{
  ...
  private static readonly Action<object> OnCellChangeDispatcher = (Action<object>) (obj => Unsafe.As<StationaryChoreRangeVisualizer>(obj).UpdateVisualizers());
  ...
  protected override void OnSpawn()
  {
    ...
    if (!this.movable)
      return;
    this.cellChangeMonitorHandle = Singleton<CellChangeMonitor>.Instance.RegisterCellChangedHandler(this.transform, StationaryChoreRangeVisualizer.OnCellChangeDispatcher, (object) this, "StationaryChoreRangeVisualizer.OnSpawn");
