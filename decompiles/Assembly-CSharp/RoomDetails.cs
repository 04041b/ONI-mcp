...
public class RoomDetails
{
  ...
  public static readonly RoomDetails.Detail ORNAMENT_COUNT = new RoomDetails.Detail((Func<Room, string>) (room =>
  {
    int num = 0;
    foreach (KPrefabID building in room.buildings)
    {
      ...
      {
        OrnamentReceptacle component = building.GetComponent<OrnamentReceptacle>();
        if (!((UnityEngine.Object) component == (UnityEngine.Object) null) && component.IsHoldingOrnament && component.IsOperational)
          ++num;
      }
    }
    foreach (KPrefabID otherEntity in room.otherEntities)
    {
      if (!((UnityEngine.Object) otherEntity == (UnityEngine.Object) null))
      {
        OrnamentReceptacle component = otherEntity.GetComponent<OrnamentReceptacle>();
        if (!((UnityEngine.Object) component == (UnityEngine.Object) null) && component.IsHoldingOrnament && component.IsOperational)
          ++num;
      }
    }
    return GameUtil.SafeStringFormat((string) ROOMS.DETAILS.ORNAMENT_COUNT.NAME, (object) num);
  }));
