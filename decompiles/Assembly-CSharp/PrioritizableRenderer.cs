...
public class PrioritizableRenderer
{
  ...
  private static Util.IterationInstruction renderEveryTickVisitHelper(
    object obj,
    PrioritizableRenderer self)
  {
    Prioritizable component = (Prioritizable) obj;
    if ((UnityEngine.Object) component != (UnityEngine.Object) null && component.showIcon && component.IsPrioritizable() && self.tool.IsActiveLayer(self.tool.GetFilterLayerFromGameObject(component.gameObject)) && component.GetMyWorldId() == ClusterManager.Instance.activeWorldId)
      self.prioritizables.Add(component);
    return Util.IterationInstruction.Continue;
  }

  public void RenderEveryTick()
  {
    if ((UnityEngine.Object) GameScreenManager.Instance == (UnityEngine.Object) null || (UnityEngine.Object) SimDebugView.Instance == (UnityEngine.Object) null || SimDebugView.Instance.GetMode() != OverlayModes.Priorities.ID)
      return;
    ...
    for (int index1 = 0; index1 < this.prioritizables.Count; ++index1)
    {
      ...
      vector3 = !((UnityEngine.Object) component != (UnityEngine.Object) null) ? prioritizable.transform.GetPosition() : component.GetWorldPivot();
