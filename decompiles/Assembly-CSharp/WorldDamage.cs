...
public class WorldDamage : KMonoBehaviour
{
        ...
        if ((UnityEngine.Object) go != (UnityEngine.Object) null)
        {
          ...
          if ((UnityEngine.Object) component != (UnityEngine.Object) null)
          {
            if (!component.invincible)
            {
              ...
              go.BoxingTrigger<BuildingHP.DamageSourceInfo>(-794517298, new BuildingHP.DamageSourceInfo()
              {
                damage = num3,
                source = source_name,
                popString = pop_text
    ...
    int disease_count)
  {
    ...
    if (!((UnityEngine.Object) component != (UnityEngine.Object) null) || !((UnityEngine.Object) component.GetMyWorld() != (UnityEngine.Object) null) || !component.GetMyWorld().worldInventory.IsReachable(component))
      return;
    PopFXManager.Instance.SpawnFX(Def.GetUISprite((object) element).first, PopFXManager.Instance.sprite_Plus, $"{Mathf.RoundToInt(num).ToString()} {element.name}", gameObject.transform, Vector3.zero);
  }
