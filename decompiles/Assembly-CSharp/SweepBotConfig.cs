...
public class SweepBotConfig : IEntityConfig
{
  ...
  public GameObject CreatePrefab()
  {
    ...
    GameObject placedEntity = EntityTemplates.CreatePlacedEntity("SweepBot", name, desc, (float) mass, anim, "idle_loop", Grid.SceneLayer.Creatures, 1, 1, decor, noise);
    ...
    kprefabId.AddTag(GameTags.OrnamentDisplayer);
    ...
    placedEntity.AddOrGet<MovingOrnamentReceptacle>().AddDepositTag(GameTags.PedestalDisplayable);
    ...
    navigator.maxProbeRadiusX = 32 /*0x20*/;
