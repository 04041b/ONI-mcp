...
public class WiltCondition : KMonoBehaviour
{
  ...
  private static readonly EventSystem.IntraObjectHandler<WiltCondition> SetEntombedDelegate = new EventSystem.IntraObjectHandler<WiltCondition>((Action<WiltCondition, object>) ((component, data) => component.SetCondition(WiltCondition.Condition.Entombed, !Boxed<bool>.Unbox(data))));
  private static readonly EventSystem.IntraObjectHandler<WiltCondition> SetRootHealthDelegate = new EventSystem.IntraObjectHandler<WiltCondition>((Action<WiltCondition, object>) ((component, data) => component.SetCondition(WiltCondition.Condition.UnhealthyRoot, Boxed<bool>.Unbox(data))));
  ...
  private static readonly EventSystem.IntraObjectHandler<WiltCondition> SetPollinatedDelegate = new EventSystem.IntraObjectHandler<WiltCondition>((Action<WiltCondition, object>) ((component, data) => component.SetCondition(WiltCondition.Condition.Pollination, Boxed<bool>.Unbox(data))));
