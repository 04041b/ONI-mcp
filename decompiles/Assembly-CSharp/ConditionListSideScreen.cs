...
public class ConditionListSideScreen : SideScreenContent
{
  ...
  private void Refresh()
  {
    ...
    {
      this.targetConditionSet.PopulateConditionSet(ProcessCondition.ProcessConditionType.All, v);
      foreach (ProcessCondition key in v)
      {
