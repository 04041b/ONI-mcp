...
public class StoryManager : KMonoBehaviour
{
  ...
  {
    int index = 0;
    StoryManager.StoryCreationTelemetry[] data = new StoryManager.StoryCreationTelemetry[((IReadOnlyCollection<KeyValuePair<string, string>>) CustomGameSettings.Instance.CurrentStoryLevelsBySetting).Count];
