...
public class MaskStation : StateMachineComponent<MaskStation.SMInstance>, IBasicBuilding
{
  ...
  private static readonly EventSystem.IntraObjectHandler<MaskStation> OnOperationalChangedDelegate = new EventSystem.IntraObjectHandler<MaskStation>((Action<MaskStation, object>) ((component, data) => component.OnOperationalChanged(((Boxed<bool>) data).value)));
