...
public class SolarPanel : Generator
{
  ...
  protected void OnActiveChanged(object data)
  {
    ...
    this.selectable.SetStatusItem(Db.Get().StatusItemCategories.Power, status_item, (object) this);
  }
  ...
  private void UpdateStatusItem()
  {
    ...
    else
    {
      if (!(this.statusHandle != Guid.Empty))
        return;
      this.selectable.ReplaceStatusItem(this.statusHandle, Db.Get().BuildingStatusItems.SolarPanelWattage, (object) this);
    }
  }
  ...
  public override void EnergySim200ms(float dt)
  {
    ...
    {
      int num2 = Grid.LightIntensity[Grid.OffsetCell(this.cachedCell, solarCellOffset)];
