...
public class Door : Workable, ISaveLoadable, ISim200ms, INavDoor
{
  ...
  public class Controller : GameStateMachine<Door.Controller, Door.Controller.Instance, Door>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      })).Enter("SetWorldStateClosed", (StateMachine<Door.Controller, Door.Controller.Instance, Door, object>.State.Callback) (smi => smi.master.SetWorldState(true))).Exit((StateMachine<Door.Controller, Door.Controller.Instance, Door, object>.State.Callback) (smi =>
      {
