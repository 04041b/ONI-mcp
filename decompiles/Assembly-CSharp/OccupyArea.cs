...
public class OccupyArea : KMonoBehaviour
{
  ...
  {
    base.OnSpawn();
    if (this.updateWithFacing && (UnityEngine.Object) this.facing != (UnityEngine.Object) null)
  ...
  private void UpdateRotatedCells()
  {
    ...
    {
      if (!this.updateWithFacing || !((UnityEngine.Object) this.facing != (UnityEngine.Object) null) || this.facingLeft == this.facing.facingLeft)
        return;
      this.facingLeft = this.facing.facingLeft;
      this._RotatedOccupiedCellsOffsets = new CellOffset[this._UnrotatedOccupiedCellsOffsets.Length];
      for (int index = 0; index < this._UnrotatedOccupiedCellsOffsets.Length; ++index)
  ...
  public int[] GetOccupiedGridCells() => this.occupiedGridCells;
