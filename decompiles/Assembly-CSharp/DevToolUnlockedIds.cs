...
public class DevToolUnlockedIds : DevTool
{
  ...
  public readonly struct UnlocksWrapper(Unlocks unlocks)
  {
    ...
    {
      return (IEnumerable<string>) ((IEnumerable<string>) this.unlocks.GetAllUnlockedIds()).OrderBy<string, string>((Func<string, string>) (s => s));
    }

    public int Count => ((IReadOnlyCollection<string>) this.unlocks.GetAllUnlockedIds()).Count;
  }
}
