...
public class CapacityControlSideScreen : SideScreenContent
{
  ...
  {
    IUserControlledCapacity controlledCapacity = target.GetComponent<IUserControlledCapacity>() ?? target.GetSMI<IUserControlledCapacity>();
    return controlledCapacity != null && controlledCapacity.ControlEnabled();
  }
