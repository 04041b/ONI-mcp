...
public class ReportManager : KMonoBehaviour
{
  ...
  public void ReportValueWithPrefabInstanceContext(
    ReportManager.ReportType reportType,
    float value,
    KPrefabID context,
    string note = null)
  ...
  public void ReportValueWithGameObjectContext(
    ReportManager.ReportType reportType,
    float value,
    GameObject context,
    string note = null)
  ...
  public class ReportEntry
  {
    ...
    public ReportManager.ReportEntry FindEntry(string dataContext)
    {
      ...
      {
        ReportManager.ReportEntry contextEntry = this.contextEntries[i];
        if (contextEntry.context == dataContext)
          return contextEntry;
      }
      return (ReportManager.ReportEntry) null;
    }

    public ReportManager.ReportEntry FindEntryFromPrefabInstance(KPrefabID prefabId)
    {
      DebugUtil.DevAssert((UnityEngine.Object) prefabId != (UnityEngine.Object) null, "Don't call with invalid context id");
      if ((UnityEngine.Object) prefabId == (UnityEngine.Object) null)
        return (ReportManager.ReportEntry) null;
      if (!prefabId.HasTag(GameTags.BaseMinion))
        return this.FindEntry(prefabId.gameObject.GetProperName());
      ReportManager.ReportEntry fromPrefabInstance = (ReportManager.ReportEntry) null;
      for (int i = 0; i < this.contextEntries.Count; ++i)
      {
        ReportManager.ReportEntry contextEntry = this.contextEntries[i];
        if (contextEntry.contextId == prefabId.InstanceID)
        {
          fromPrefabInstance = contextEntry;
          break;
        }
      }
      if (fromPrefabInstance == null)
      {
        string properName = prefabId.gameObject.GetProperName();
        for (int i = 0; i < this.contextEntries.Count; ++i)
        {
          ReportManager.ReportEntry contextEntry = this.contextEntries[i];
          if (contextEntry.contextId == 0 && !(contextEntry.context != properName))
          {
            contextEntry.contextId = prefabId.InstanceID;
            fromPrefabInstance = contextEntry;
            break;
          }
        }
      }
      return fromPrefabInstance;
    }

    public ReportManager.ReportEntry FindEntryFromGameObject(GameObject contextGameObject)
    {
      DebugUtil.DevAssert((UnityEngine.Object) contextGameObject != (UnityEngine.Object) null, "Don't call with invalid context id");
      if ((UnityEngine.Object) contextGameObject == (UnityEngine.Object) null)
        return (ReportManager.ReportEntry) null;
      KPrefabID component;
      return !contextGameObject.TryGetComponent<KPrefabID>(out component) ? this.FindEntry(contextGameObject.GetProperName()) : this.FindEntryFromPrefabInstance(component);
    }
    ...
    private void AddDataToContext(
      ...
      string note)
    {
      DebugUtil.DevAssert(context != null, "context must be non-null");
      if (context == null)
        return;
    ...
    private void AddDataToProperNameContext(
      ReportManager.NoteStorage note_storage,
      float value,
      GameObject context,
      string note)
    {
      DebugUtil.DevAssert((UnityEngine.Object) context != (UnityEngine.Object) null, "context must be non-null");
      if (!((UnityEngine.Object) context != (UnityEngine.Object) null))
        return;
      this.AddDataToContext(note_storage, value, context.GetProperName(), note);
    }

    private void AddDataToPrefabInstanceContext(
      ReportManager.NoteStorage note_storage,
      float value,
      KPrefabID context,
      string note)
    ...
    public void AddDataWithPrefabInstanceContext(
      ReportManager.NoteStorage note_storage,
      float value,
      KPrefabID context,
      string note = null)
    {
      this.AddActualData(note_storage, value, note);
      DebugUtil.DevAssert((UnityEngine.Object) context != (UnityEngine.Object) null, "Use the other overload of AddData for null contexts");
      this.AddDataToPrefabInstanceContext(note_storage, value, context, note);
    }

    public void AddDataWithGameObjectContext(
      ReportManager.NoteStorage note_storage,
      float value,
      GameObject context,
      string note = null)
    {
      ...
      if ((UnityEngine.Object) context == (UnityEngine.Object) null)
        return;
      KPrefabID component;
      if (context.TryGetComponent<KPrefabID>(out component))
        this.AddDataToPrefabInstanceContext(note_storage, value, component, note);
      else
