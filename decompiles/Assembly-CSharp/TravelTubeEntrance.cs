  ...
  ISim200ms
{
  ...
  protected override void OnSpawn()
  {
    ...
    this.TubeConnectionsChanged(Game.Instance.travelTubeSystem.GetConnections(Grid.XYToCell(x, y), true));
  ...
  {
    Game.Instance.userMenu.AddButton(this.gameObject, this.smi.buttonInfo);
  ...
  {
    bool operational = ((Boxed<bool>) data).value;
    ...
    GameStateMachine<TravelTubeEntrance.States, TravelTubeEntrance.SMInstance, TravelTubeEntrance, object>.GameInstance
  {
    ...
    public SMInstance(TravelTubeEntrance master)
      : base(master)
    {
      this.buttonInfo = new KIconButtonMenu.ButtonInfo("action_speed_up", (string) UI.USERMENUACTIONS.TRANSITTUBEWAX.NAME, (System.Action) (() => master.SetWaxUse(true)), tooltipText: (string) UI.USERMENUACTIONS.TRANSITTUBEWAX.TOOLTIP);
    }

    public void RefreshUIButton()
    {
      if (!this.master.deliverAndUseWax)
      {
        this.buttonInfo.iconName = "action_speed_up";
        this.buttonInfo.text = (string) UI.USERMENUACTIONS.TRANSITTUBEWAX.NAME;
        this.buttonInfo.onClick = (System.Action) (() => this.master.SetWaxUse(true));
        this.buttonInfo.tooltipText = (string) UI.USERMENUACTIONS.TRANSITTUBEWAX.TOOLTIP;
      }
      else
      {
        this.buttonInfo.iconName = "action_speed_up";
        this.buttonInfo.text = (string) UI.USERMENUACTIONS.CANCELTRANSITTUBEWAX.NAME;
        this.buttonInfo.onClick = (System.Action) (() => this.master.SetWaxUse(false));
        this.buttonInfo.tooltipText = (string) UI.USERMENUACTIONS.CANCELTRANSITTUBEWAX.TOOLTIP;
      }
    }
  }
}
