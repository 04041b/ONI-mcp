...
public class BuildingStatusItems : StatusItems
{
  ...
  private void CreateStatusItems()
  {
    ...
    this.MissingFoundationBackwall = this.CreateStatusItem("MissingFoundationBackwall", "BUILDING", "status_item_missing_foundation", StatusItem.IconType.Custom, NotificationType.BadMinor, false, OverlayModes.None.ID);
    ...
    this.PedestalNoItemDisplayed = this.CreateStatusItem("PedestalNoItemDisplayed", "BUILDING", "", StatusItem.IconType.Info, NotificationType.BadMinor, false, OverlayModes.None.ID);
    this.OrnamentDisabled = this.CreateStatusItem("OrnamentDisabled", "BUILDING", "status_item_missing_foundation", StatusItem.IconType.Custom, NotificationType.BadMinor, false, OverlayModes.None.ID);
    ...
    this.SpacePOIHarvesting = new StatusItem("SpacePOIHarvesting", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    this.SpacePOIHarvesting.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
      ...
      ClusterGridEntity atCurrentLocation = statesInstance.gameObject.GetComponent<RocketModuleCluster>().CraftInterface.GetComponent<Clustercraft>().GetPOIAtCurrentLocation();
      string str3 = (UnityEngine.Object) atCurrentLocation == (UnityEngine.Object) null ? "Unknown POI" : atCurrentLocation.GetProperName();
      return GameUtil.SafeStringFormat((string) BUILDING.STATUSITEMS.SPACEPOIHARVESTING.NAME, (object) str3, (object) GameUtil.GetFormattedMass(statesInstance.def.harvestSpeed, GameUtil.TimeSlice.PerSecond));
    });
    this.SpacePOIHarvesting.resolveTooltipCallback = (Func<string, object, string>) ((s, d) => (string) BUILDING.STATUSITEMS.SPACEPOIHARVESTING.TOOLTIP);
    this.CollectingHexCellInventoryItems = new StatusItem("CollectingHexCellInventoryItems", "BUILDING", "", StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID);
    ...
    this.MegaBrainTankActivationProgress.resolveStringCallback = (Func<string, object, string>) ((str, data) =>
    {
      ...
      return str.Replace("{ActivationProgress}", $"{statesInstance.JournalsStored}/{(ValueType) (short) 25}");
    });
