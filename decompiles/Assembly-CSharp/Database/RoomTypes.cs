...
public class RoomTypes : ResourceSet<RoomType>
{
    ...
    : base(nameof (RoomTypes), parent)
  {
    ...
    this.BanquetHall = this.Add(new RoomType(nameof (BanquetHall), (string) ROOMS.TYPES.BANQUETHALL.NAME, (string) ROOMS.TYPES.BANQUETHALL.DESCRIPTION, (string) ROOMS.TYPES.BANQUETHALL.TOOLTIP, (string) ROOMS.TYPES.BANQUETHALL.EFFECT, Db.Get().RoomTypeCategories.Food, RoomConstraints.MULTI_MINION_DINING_TABLE, new RoomConstraints.Constraint[7]
    {
      RoomConstraints.NO_INDUSTRIAL_MACHINERY,
    ...
    }, 1, effects: new string[1]{ "RoomBanquetHall" }, sortKey: 7));
    this.GreatHall = this.Add(new RoomType(nameof (GreatHall), (string) ROOMS.TYPES.GREATHALL.NAME, (string) ROOMS.TYPES.GREATHALL.DESCRIPTION, (string) ROOMS.TYPES.GREATHALL.TOOLTIP, (string) ROOMS.TYPES.GREATHALL.EFFECT, Db.Get().RoomTypeCategories.Food, RoomConstraints.DINING_TABLE, new RoomConstraints.Constraint[5]
    {
      RoomConstraints.NO_INDUSTRIAL_MACHINERY,
      RoomConstraints.MINIMUM_SIZE_32,
      RoomConstraints.MAXIMUM_SIZE_120,
    ...
    }, new RoomDetails.Detail[3]
    {
      ...
      RoomDetails.BUILDING_COUNT,
      RoomDetails.ORNAMENT_COUNT
    }, 1, new RoomType[1]{ this.BanquetHall }, effects: new string[1]
    {
      "RoomGreatHall"
    }, sortKey: 6));
    this.MessHall = this.Add(new RoomType(nameof (MessHall), (string) ROOMS.TYPES.MESSHALL.NAME, (string) ROOMS.TYPES.MESSHALL.DESCRIPTION, (string) ROOMS.TYPES.MESSHALL.TOOLTIP, (string) ROOMS.TYPES.MESSHALL.EFFECT, Db.Get().RoomTypeCategories.Food, RoomConstraints.DINING_TABLE, new RoomConstraints.Constraint[3]
    {
      RoomConstraints.NO_INDUSTRIAL_MACHINERY,
      RoomConstraints.MINIMUM_SIZE_12,
      RoomConstraints.MAXIMUM_SIZE_64
    ...
    }, 1, new RoomType[2]
    {
      this.GreatHall,
      this.BanquetHall
    }, effects: new string[1]{ "RoomMessHall" }, sortKey: 5));
