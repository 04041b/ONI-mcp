...
public class Skills : ResourceSet<Skill>
{
    ...
    : base(nameof (Skills), parent)
  {
    ...
    string name27 = (string) DUPLICANTS.ROLES.BIONICS_D1.NAME;
    string description19 = (string) DUPLICANTS.ROLES.BIONICS_D1.DESCRIPTION;
    string id19 = Db.Get().SkillGroups.BionicSkills.Id;
    List<SkillPerk> perks19 = new List<SkillPerk>();
    perks19.Add(Db.Get().SkillPerks.BionicEardrumsDefense);
    perks19.Add(Db.Get().SkillPerks.BionicMinorEyeIrritationDefense);
    perks19.Add(Db.Get().SkillPerks.BionicMajorEyeIrritationDefense);
    List<string> priorSkills19 = new List<string>();
    string name28 = GameTags.Minions.Models.Bionic.Name;
    string[] dlC3_9 = DlcManager.DLC3;
    this.BionicsD1 = this.AddSkill(new Skill(nameof (BionicsD1), name27, description19, 0, "hat_role_gainingboosters1", "skillbadge_bionic_booster1", id19, perks19, priorSkills19, name28, dlC3_9));
    string name29 = (string) DUPLICANTS.ROLES.BIONICS_D2.NAME;
    string description20 = (string) DUPLICANTS.ROLES.BIONICS_D2.DESCRIPTION;
    string id20 = Db.Get().SkillGroups.BionicSkills.Id;
    List<SkillPerk> perks20 = new List<SkillPerk>();
    perks20.Add(Db.Get().SkillPerks.BionicToastySurroundingsDefense);
    perks20.Add(Db.Get().SkillPerks.BionicChillySurroundingsDefense);
    List<string> priorSkills20 = new List<string>();
    priorSkills20.Add(this.BionicsD1.Id);
    string name30 = GameTags.Minions.Models.Bionic.Name;
    string[] dlC3_10 = DlcManager.DLC3;
    this.BionicsD2 = this.AddSkill(new Skill(nameof (BionicsD2), name29, description20, 1, "hat_role_gainingboosters1", "skillbadge_bionic_booster1", id20, perks20, priorSkills20, name30, dlC3_10));
  }
