...
public static class BasePuftConfig
{
    ...
    float lethalHighTemperature)
  {
    ...
    int num = !is_baby ? 1 : 0;
    ChoreTable.Builder chore_table = builder.Add((StateMachine.BaseDef) def, num != 0).Add((StateMachine.BaseDef) new CritterEmoteStates.Def(Assets.GetAnim((HashedString) "puft_emotes_kanim")), !is_baby).PopInterruptGroup().Add((StateMachine.BaseDef) new IdleStates.Def()
    {
