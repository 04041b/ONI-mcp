...
public class DivergentBeetleConfig : IEntityConfig, IHasDlcRestrictions
{
  ...
  public static GameObject CreateDivergentBeetle(
    ...
    bool is_baby)
  {
    GameObject wildCreature = EntityTemplates.ExtendEntityToWildCreature(BaseDivergentConfig.BaseDivergent(id, name, desc, 50f, anim_file, is_baby ? (string) null : "critter_build_kanim", "DivergentBeetleBaseTrait", is_baby), DivergentTuning.PEN_SIZE_PER_CREATURE);
