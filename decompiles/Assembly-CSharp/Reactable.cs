...
public abstract class Reactable
{
  ...
  private static readonly Action<object> UpdateLocationDispatcher = (Action<object>) (obj => Unsafe.As<Reactable>(obj).UpdateLocation());
  ...
  public void Initialize(bool followTransform)
  {
    ...
    if (!followTransform)
      return;
    this.cellChangedHandleID = Singleton<CellChangeMonitor>.Instance.RegisterCellChangedHandler(this.gameObject.transform, Reactable.UpdateLocationDispatcher, (object) this, "Reactable follow transform");
  }
