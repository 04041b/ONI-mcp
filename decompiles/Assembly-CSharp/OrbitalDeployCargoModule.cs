  ...
  GameStateMachine<OrbitalDeployCargoModule, OrbitalDeployCargoModule.StatesInstance, IStateMachineTarget, OrbitalDeployCargoModule.Def>
{
    ...
    IEmptyableCargo
  {
      ...
      : base(master, def)
    {
      ...
      this.gameObject.Subscribe(-887025858, new System.Action<object>(this.OnRocketLanded));
    }
    ...
    protected override void OnCleanUp()
    {
      ...
      this.gameObject.Unsubscribe(-887025858, new System.Action<object>(this.OnRocketLanded));
      base.OnCleanUp();
    }

    private void OnRocketLanded(object obj)
    {
      TreeFilterable component = this.gameObject.GetComponent<TreeFilterable>();
      if (!((UnityEngine.Object) component != (UnityEngine.Object) null) || component.OnFilterChanged == null)
        return;
