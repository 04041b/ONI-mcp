  ...
  public static CodexEntryGenerator_Elements.ElementEntryContext GetElementEntryContext()
  {
    if (CodexEntryGenerator_Elements.contextInstance == null)
    {
        ...
        CodexEntryGenerator_Elements.CodexElementMap made)
      {
        ...
        HashSet<ElementUsage> elementUsageSet = new HashSet<ElementUsage>();
        ...
        if ((bool) (UnityEngine.Object) component1)
        {
          ...
          foreach (EnergyGenerator.OutputItem outputItem in (IEnumerable<EnergyGenerator.OutputItem>) component1.formula.outputs ?? Enumerable.Empty<EnergyGenerator.OutputItem>())
          {
            ...
            elementUsageSet.Add(new ElementUsage(tag, outputItem.creationRate, true));
          }
        }
        foreach (ElementConverter elementConverter in (IEnumerable<ElementConverter>) prefab.GetComponents<ElementConverter>() ?? Enumerable.Empty<ElementConverter>())
        {
          ...
          foreach (ElementConverter.ConsumedElement consumedElement in (IEnumerable<ElementConverter.ConsumedElement>) elementConverter.consumedElements ?? Enumerable.Empty<ElementConverter.ConsumedElement>())
          {
            ...
            if (elementConverter.inputIsCategory)
            {
              ...
              inSet.Add(new ElementUsage(c.Tag, c.MassConsumptionRate, true));
          }
          foreach (ElementConverter.OutputElement outputElement in (IEnumerable<ElementConverter.OutputElement>) elementConverter.outputElements ?? Enumerable.Empty<ElementConverter.OutputElement>())
          {
            ...
            if (elementConverter.inputIsCategory)
            {
              ...
              elementUsageSet.Add(elementUsage);
          }
        ...
        if ((UnityEngine.Object) component3 != (UnityEngine.Object) null && component2 == null)
          elementUsageSet.Add(new ElementUsage((Tag) component3.cropId, (float) component3.cropVal.numProduced / component3.cropVal.cropDuration, true));
        FlushToilet component4 = prefab.GetComponent<FlushToilet>();
        if ((bool) (UnityEngine.Object) component4)
        {
          inSet.Add(new ElementUsage(waterTag, component4.massConsumedPerUse, false));
          elementUsageSet.Add(new ElementUsage(dirtyWaterTag, component4.massEmittedPerUse, false));
        }
        ...
        if ((bool) (UnityEngine.Object) component5)
        {
          ...
          inSet.Add(new ElementUsage(tag1, component5.massConsumedPerUse, false));
          if (component5.outputElement != SimHashes.Vacuum)
          {
            Tag tag2 = ElementLoader.FindElementByHash(component5.outputElement).tag;
            elementUsageSet.Add(new ElementUsage(tag2, component5.massConsumedPerUse, false));
          }
        }
        ...
        ce1.prefab = prefab;
        ce1.inSet = inSet;
        ce1.outSet = elementUsageSet;
        if (inSet.Count > 0 && elementUsageSet.Count > 0)
          usedMap.Add(prefab.PrefabID(), ce1);
        foreach (ElementUsage elementUsage in inSet)
          usedMap.Add(elementUsage.tag, ce1);
        foreach (ElementUsage elementUsage in elementUsageSet)
          madeMap.Add(elementUsage.tag, ce1);
        if ((UnityEngine.Object) component3 != (UnityEngine.Object) null && component2 == null)
          AddPlantFiberInfo(ref inSet, usedMap, madeMap, prefab, prefab, component3);
        ...
        if (implementingInterface != null)
        {
          ...
          if ((UnityEngine.Object) prefab1 != (UnityEngine.Object) null)
          {
            ...
            if ((UnityEngine.Object) component6 != (UnityEngine.Object) null && ((UnityEngine.Object) component3 == (UnityEngine.Object) null || component6.cropId != component3.cropId || component6.cropVal.numProduced != component3.cropVal.numProduced))
            {
              ...
              AddPlantFiberInfo(ref inSet, usedMap, madeMap, prefab1, prefab, component6, (Func<Tag, float, bool, string>) ((t, a, b) => GameUtil.GetFormattedBranchGrowerPlantPlantFiberProductionValuePerCycle(t, a, branchCount)));
            }
          }
        }
        if (component2 != null)
        ...
        if (def7 != null)
        {
          ...
          GameObject prefab2 = Assets.GetPrefab((Tag) "MilkingStation");
          ce6.title = prefab2.GetProperName();
          ce6.prefab = prefab2;
          ce6.inSet = new HashSet<ElementUsage>();
          ce6.inSet.Add(new ElementUsage(prefab.PrefabID(), 1f, false));
          usedMap.Add(prefab.PrefabID(), ce6);
          ce6.outSet = new HashSet<ElementUsage>();
          ce6.outSet.Add(new ElementUsage(def7.element.CreateTag(), def7.Capacity, false));
          madeMap.Add(def7.element.CreateTag(), ce6);
        }
        Butcherable component8 = prefab.GetComponent<Butcherable>();
        if (!((UnityEngine.Object) component8 != (UnityEngine.Object) null))
          return;
        CodexEntryGenerator_Elements.ConversionEntry ce7 = new CodexEntryGenerator_Elements.ConversionEntry();
        ce7.title = prefab.GetProperName();
        ce7.prefab = prefab;
        usedMap.Add(prefab.PrefabID(), ce7);
        ce7.outSet = new HashSet<ElementUsage>();
        ...
        foreach (KeyValuePair<string, float> keyValuePair in dictionary)
        {
          ...
          string t = str;
          float amount = num;
          ce7.outSet.Add(new ElementUsage((Tag) t, amount, false));
          madeMap.Add((Tag) t, ce7);
        }
      }
    }
    return CodexEntryGenerator_Elements.contextInstance;

    static void AddPlantFiberInfo(
      ...
      Crop crop,
      Func<Tag, float, bool, string> customFormating = null)
    {
      ...
      ce.inSet = inSet;
      ce.outSet.Add(new ElementUsage((Tag) "PlantFiber", component.amount / crop.cropVal.cropDuration, true, customFormating));
