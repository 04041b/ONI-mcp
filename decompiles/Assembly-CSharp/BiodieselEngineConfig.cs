...
public class BiodieselEngineConfig : IBuildingConfig
{
  ...
  public override BuildingDef CreateBuildingDef()
  {
    ...
    BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("BiodieselEngine", 7, 5, "rocket_biodiesel_engine_kanim", 1000, 60f, engineMassSmall, construction_materials, 9999f, BuildLocationRule.OnFloor, none, noise);
  ...
  public override void DoPostConfigureComplete(GameObject go)
  {
    ...
    BuildingTemplates.ExtendBuildingToRocketModule(go, "rocket_biodiesel_engine_bg_kanim");
  }
}
