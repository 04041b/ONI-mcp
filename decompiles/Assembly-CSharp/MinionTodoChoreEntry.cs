...
public class MinionTodoChoreEntry : KMonoBehaviour
{
  ...
  public void Apply(Chore.Precondition.Context context)
  {
    ...
    string sourceText1 = ((string) STRINGS.UI.UISIDESCREENS.MINIONTODOSIDESCREEN.CHORE_TARGET).Replace("{Target}", (UnityEngine.Object) context.chore.target.gameObject == (UnityEngine.Object) consumer.gameObject ? STRINGS.UI.UISIDESCREENS.MINIONTODOSIDESCREEN.SELF_LABEL.text : context.chore.target.gameObject.GetProperName());
    if (newValue != null)
      sourceText1 = sourceText1.Replace("{Groups}", newValue);
    string sourceText2 = context.chore.masterPriority.priority_class == PriorityScreen.PriorityClass.basic ? context.chore.masterPriority.priority_value.ToString() : "";
    ...
    this.subLabel.SetText(sourceText1);
    this.priorityLabel.SetText(sourceText2);
