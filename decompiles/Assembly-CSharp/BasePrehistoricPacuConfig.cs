...
public static class BasePrehistoricPacuConfig
{
    ...
    float lethalHighTemp)
  {
    ...
    KAnimFile anim = Assets.GetAnim((HashedString) (is_baby ? anim_file : "paculacanth_build_kanim"));
    int width = num1;
    int height = num2;
