...
public class Dreamer : GameStateMachine<Dreamer, Dreamer.Instance>
{
  ...
  public override void InitializeStates(out StateMachine.BaseState default_state)
  {
    ...
    this.notDreaming.OnSignal(this.startDreaming, this.dreaming, (StateMachine<Dreamer, Dreamer.Instance, IStateMachineTarget, object>.Parameter<StateMachine<Dreamer, Dreamer.Instance, IStateMachineTarget, object>.SignalParameter>.Callback) ((smi, param) => smi.currentDream != null));
