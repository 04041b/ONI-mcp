...
public class NoisePolluter : KMonoBehaviour, IPolluter
{
  ...
  private static readonly Action<object> RefreshDispatcher = (Action<object>) (obj => Unsafe.As<NoisePolluter>(obj).Refresh());
  ...
  protected override void OnSpawn()
  {
    ...
    else
    {
      ...
      this.cellChangedHandlerCallback = Singleton<CellChangeMonitor>.Instance.RegisterCellChangedHandler(this.transform, NoisePolluter.RefreshDispatcher, (object) this, "NoisePolluter.OnSpawn");
