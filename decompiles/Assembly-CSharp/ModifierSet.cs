...
public class ModifierSet : ScriptableObject
{
  ...
  public void CreateCritteEffects()
  {
    ...
    this.effects.Add(resource7);
    Effect resource8 = new Effect("HuskyMooFed", (string) STRINGS.CREATURES.MODIFIERS.HUSKYMOOFED.NAME, (string) STRINGS.CREATURES.MODIFIERS.HUSKYMOOFED.TOOLTIP, 1f, true, true, false);
    resource8.Add(new AttributeModifier(Db.Get().Amounts.Beckoning.deltaAttribute.Id, MooTuning.WELLFED_EFFECT, (string) STRINGS.CREATURES.MODIFIERS.HUSKYMOOFED.NAME));
    this.effects.Add(resource8);
    Effect resource9 = new Effect("HuskyMooWellFed", (string) STRINGS.CREATURES.MODIFIERS.HUSKYMOOWELLFED.NAME, (string) STRINGS.CREATURES.MODIFIERS.HUSKYMOOWELLFED.TOOLTIP, 1f, true, true, false);
    resource9.Add(new AttributeModifier(Db.Get().Amounts.MilkProduction.deltaAttribute.Id, MooTuning.MILK_PRODUCTION_PERCENTAGE_PER_SECOND, (Func<string>) (() => GameUtil.SafeStringFormat((string) STRINGS.CREATURES.STATS.MILKPRODUCTION.DISPLAYED_NAME, (object) UI.StripLinkFormatting(ElementLoader.FindElementByHash(DieselMooConfig.MILK_ELEMENT).name))), (Func<string>) (() => (string) STRINGS.CREATURES.MODIFIERS.HUSKYMOOWELLFED.NAME)));
    this.effects.Add(resource9);
    Effect resource10 = new Effect("WoodDeerWellFed", (string) STRINGS.CREATURES.MODIFIERS.DEERWELLFED.NAME, (string) STRINGS.CREATURES.MODIFIERS.DEERWELLFED.TOOLTIP, 1f, true, true, false);
    resource10.Add(new AttributeModifier(Db.Get().Amounts.ScaleGrowth.deltaAttribute.Id, (float) (100.0 / ((double) WoodDeerConfig.ANTLER_GROWTH_TIME_IN_CYCLES * 600.0)), (Func<string>) (() => (string) STRINGS.CREATURES.STATS.SCALEGROWTH.GET_DISPLAYED_NAME()[(Tag) "WoodDeer"]), (Func<string>) (() => (string) STRINGS.CREATURES.MODIFIERS.DEERWELLFED.NAME)));
    this.effects.Add(resource10);
    Effect resource11 = new Effect("GlassDeerWellFed", (string) STRINGS.CREATURES.MODIFIERS.DEERWELLFED.NAME, (string) STRINGS.CREATURES.MODIFIERS.DEERWELLFED.TOOLTIP, 1f, true, true, false);
    resource11.Add(new AttributeModifier(Db.Get().Amounts.ScaleGrowth.deltaAttribute.Id, 0.027777778f, (Func<string>) (() => (string) STRINGS.CREATURES.STATS.SCALEGROWTH.GET_DISPLAYED_NAME()[(Tag) "GlassDeer"]), (Func<string>) (() => (string) STRINGS.CREATURES.MODIFIERS.DEERWELLFED.NAME)));
    this.effects.Add(resource11);
    Effect resource12 = new Effect("IceBellyWellFed", (string) STRINGS.CREATURES.MODIFIERS.ICEBELLYWELLFED.NAME, (string) STRINGS.CREATURES.MODIFIERS.ICEBELLYWELLFED.TOOLTIP, 1f, true, true, false);
    resource12.Add(new AttributeModifier(Db.Get().Amounts.ScaleGrowth.deltaAttribute.Id, (float) (100.0 / ((double) IceBellyConfig.SCALE_GROWTH_TIME_IN_CYCLES * 600.0)), (Func<string>) (() => (string) STRINGS.CREATURES.STATS.SCALEGROWTH.GET_DISPLAYED_NAME()[(Tag) "IceBelly"]), (Func<string>) (() => (string) STRINGS.CREATURES.MODIFIERS.ICEBELLYWELLFED.NAME)));
    this.effects.Add(resource12);
    Effect resource13 = new Effect("GoldBellyWellFed", (string) STRINGS.CREATURES.MODIFIERS.GOLDBELLYWELLFED.NAME, (string) STRINGS.CREATURES.MODIFIERS.GOLDBELLYWELLFED.TOOLTIP, 1f, true, true, false);
    resource13.Add(new AttributeModifier(Db.Get().Amounts.ScaleGrowth.deltaAttribute.Id, 0.0166666675f, (Func<string>) (() => (string) STRINGS.CREATURES.STATS.SCALEGROWTH.GET_DISPLAYED_NAME()[(Tag) "GoldBelly"]), (Func<string>) (() => (string) STRINGS.CREATURES.MODIFIERS.GOLDBELLYWELLFED.NAME)));
    this.effects.Add(resource13);
    Effect resource14 = new Effect("ButterflyPollinated", (string) STRINGS.CREATURES.MODIFIERS.BUTTERFLYPOLLINATED.NAME, (string) STRINGS.CREATURES.MODIFIERS.BUTTERFLYPOLLINATED.TOOLTIP, 600f, true, true, false);
    resource14.Add(new AttributeModifier(Db.Get().Amounts.Maturity.deltaAttribute.Id, 0.25f, (string) STRINGS.CREATURES.MODIFIERS.BUTTERFLYPOLLINATED.NAME, true));
    resource14.Add(new AttributeModifier(Db.Get().Amounts.Maturity2.deltaAttribute.Id, 0.25f, (string) STRINGS.CREATURES.MODIFIERS.BUTTERFLYPOLLINATED.NAME, true));
    ...
    Effect resource15 = new Effect("RaptorWellFed", (string) STRINGS.CREATURES.MODIFIERS.RAPTORWELLFED.NAME, (string) STRINGS.CREATURES.MODIFIERS.RAPTORWELLFED.TOOLTIP, 1f, true, true, false);
    resource15.Add(new AttributeModifier(Db.Get().Amounts.ScaleGrowth.deltaAttribute.Id, (float) (100.0 / ((double) RaptorConfig.SCALE_GROWTH_TIME_IN_CYCLES * 600.0)), (Func<string>) (() => (string) STRINGS.CREATURES.STATS.SCALEGROWTH.GET_DISPLAYED_NAME()[(Tag) "Raptor"]), (Func<string>) (() => (string) STRINGS.CREATURES.MODIFIERS.RAPTORWELLFED.NAME)));
