...
public class EggCrackerConfig : IBuildingConfig
{
  ...
  {
    EggCrackerConfig.uncategorizedEggData.Add(new EggCrackerConfig.EggData(eggPrefabTag, name, description, mass, requiredDLC, forbiddenDLC, allowCrackerRecipeCreation)
    {
