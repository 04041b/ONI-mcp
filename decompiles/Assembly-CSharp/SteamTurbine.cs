...
public class SteamTurbine : Generator
{
  ...
  private static Action<Sim.MassConsumedCallback, object> OnSimConsumeCallback = (Action<Sim.MassConsumedCallback, object>) ((mass_cb_info, data) => ((SteamTurbine) data).OnSimConsume(mass_cb_info));
  ...
  private void Pump(float dt)
  {
    ...
    {
      HandleVector<Game.ComplexCallbackInfo<Sim.MassConsumedCallback>>.Handle handle = Game.Instance.massConsumedCallbackManager.Add(SteamTurbine.OnSimConsumeCallback, (object) this, "SteamTurbineConsume");
