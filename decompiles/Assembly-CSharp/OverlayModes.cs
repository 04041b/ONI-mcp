...
public abstract class OverlayModes
{
      ...
      foreach (SaveLoadRoot layerTarget in this.layerTargets)
      {
        if (!((UnityEngine.Object) layerTarget == (UnityEngine.Object) null))
        {
          ...
          if (component1 != null)
          {
            ...
            int networkCell = component1.GetNetworkCell();
            UtilityNetwork networkForCell = Game.Instance.electricalConduitSystem.GetNetworkForCell(networkCell);
            ...
            if ((double) wattsUsedByCircuit == -1.0)
              wattsUsedByCircuit = this.previousTilePower[networkCell];
            else
              this.previousTilePower[networkCell] = wattsUsedByCircuit;
  ...
  public class TileMode : OverlayModes.Mode
  {
    ...
    private static Util.IterationInstruction updateVisitor(
      object obj,
      ref (OverlayModes.TileMode, Vector2I, Vector2I) context)
    {
    ...
    public override void Update()
    {
      ...
      Vector2I max;
      Grid.GetVisibleExtents(out min, out max);
      (OverlayModes.TileMode, Vector2I, Vector2I) context = (this, min, max);
      ...
      GameScenePartitioner.Instance.VisitEntries<(OverlayModes.TileMode, Vector2I, Vector2I)>(extents.x, extents.y, extents.width, extents.height, GameScenePartitioner.Instance.pickupablesLayer, new GameScenePartitioner.VisitorRef<(OverlayModes.TileMode, Vector2I, Vector2I)>(OverlayModes.TileMode.updateVisitor), ref context);
      GameScenePartitioner.Instance.VisitEntries<(OverlayModes.TileMode, Vector2I, Vector2I)>(extents.x, extents.y, extents.width, extents.height, GameScenePartitioner.Instance.completeBuildings, new GameScenePartitioner.VisitorRef<(OverlayModes.TileMode, Vector2I, Vector2I)>(OverlayModes.TileMode.updateVisitor), ref context);
