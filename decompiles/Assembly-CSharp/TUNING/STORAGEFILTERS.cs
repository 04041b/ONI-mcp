...
public class STORAGEFILTERS
{
  ...
  public static List<Tag> STORAGE_SOLID_CARGO_BAY = STORAGEFILTERS.NOT_EDIBLE_SOLIDS.Union<Tag>((IEnumerable<Tag>) new List<Tag>()
  {
    GameTags.Medicine
  }).Except<Tag>((IEnumerable<Tag>) new List<Tag>()
  {
    GameTags.TechComponents
  }).ToList<Tag>();
