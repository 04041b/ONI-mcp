  ...
  IPointerUpHandler
{
  ...
  private void RestoreCachedVertexAttributes(int index)
  {
    ...
    Vector4[] uvs0_1 = this.m_cachedMeshInfoVertexData[materialReferenceIndex].uvs0;
    Vector4[] uvs0_2 = this.m_TextMeshPro.textInfo.meshInfo[materialReferenceIndex].uvs0;
    ...
    Vector4[] uvs0_3 = this.m_cachedMeshInfoVertexData[materialReferenceIndex].uvs0;
    Vector4[] uvs0_4 = this.m_TextMeshPro.textInfo.meshInfo[materialReferenceIndex].uvs0;
