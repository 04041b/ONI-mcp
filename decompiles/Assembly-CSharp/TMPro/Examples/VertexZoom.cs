      ...
      else
      {
        ...
        for (int index = 0; index < characterCount; ++index)
        {
          if (textInfo.characterInfo[index].isVisible)
          {
            ...
            Vector4[] uvs0_1 = cachedMeshInfoVertexData[materialReferenceIndex].uvs0;
            Vector4[] uvs0_2 = textInfo.meshInfo[materialReferenceIndex].uvs0;
        ...
        for (int index = 0; index < textInfo.meshInfo.Length; ++index)
        {
          ...
          textInfo.meshInfo[index].mesh.SetUVs(0, textInfo.meshInfo[index].uvs0);
