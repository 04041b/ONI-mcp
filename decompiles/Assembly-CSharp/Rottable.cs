  ...
  GameStateMachine<Rottable, Rottable.Instance, IStateMachineTarget, Rottable.Def>
{
  ...
  public override void InitializeStates(out StateMachine.BaseState default_state)
  {
    ...
    double num1;
    this.Fresh.ToggleStatusItem(Db.Get().CreatureStatusItems.Fresh, (Func<Rottable.Instance, object>) (smi => (object) smi)).ToggleTag(GameTags.RotModifierTags.Fresh).ParamTransition<float>((StateMachine<Rottable, Rottable.Instance, IStateMachineTarget, Rottable.Def>.Parameter<float>) this.rotParameter, this.Stale_Pre, (StateMachine<Rottable, Rottable.Instance, IStateMachineTarget, Rottable.Def>.Parameter<float>.Callback) ((smi, p) => (double) p <= (double) smi.def.spoilTime - ((double) smi.def.spoilTime - (double) smi.def.staleTime))).Update((System.Action<Rottable.Instance, float>) ((smi, dt) => num1 = (double) smi.sm.rotParameter.Set(smi.RotValue, smi)), UpdateRate.SIM_1000ms, true).FastUpdate("Rot", (UpdateBucketWithUpdater<Rottable.Instance>.IUpdater) Rottable.rotCB, UpdateRate.SIM_1000ms, true);
    ...
    double num2;
    this.Stale.ToggleStatusItem(Db.Get().CreatureStatusItems.Stale, (Func<Rottable.Instance, object>) (smi => (object) smi)).ParamTransition<float>((StateMachine<Rottable, Rottable.Instance, IStateMachineTarget, Rottable.Def>.Parameter<float>) this.rotParameter, this.Fresh, (StateMachine<Rottable, Rottable.Instance, IStateMachineTarget, Rottable.Def>.Parameter<float>.Callback) ((smi, p) => (double) p > (double) smi.def.spoilTime - ((double) smi.def.spoilTime - (double) smi.def.staleTime))).ParamTransition<float>((StateMachine<Rottable, Rottable.Instance, IStateMachineTarget, Rottable.Def>.Parameter<float>) this.rotParameter, this.Spoiled, GameStateMachine<Rottable, Rottable.Instance, IStateMachineTarget, Rottable.Def>.IsLTEZero).ToggleTag(GameTags.RotModifierTags.Stale).Update((System.Action<Rottable.Instance, float>) ((smi, dt) => num2 = (double) smi.sm.rotParameter.Set(smi.RotValue, smi)), UpdateRate.SIM_1000ms).FastUpdate("Rot", (UpdateBucketWithUpdater<Rottable.Instance>.IUpdater) Rottable.rotCB, UpdateRate.SIM_1000ms);
      ...
      if (!component.HasAnyTags(Rottable.PRESERVED_TAGS))
      {
        switch (Rottable.RefrigerationLevel((IRottable) this))
        {
          case Rottable.RotRefrigerationLevel.Refrigerated:
            ...
            component.AddTag(GameTags.RotModifierTags.Refrigerated);
          ...
          case Rottable.RotRefrigerationLevel.Frozen:
            ...
            component.AddTag(GameTags.RotModifierTags.DeepFrozen);
