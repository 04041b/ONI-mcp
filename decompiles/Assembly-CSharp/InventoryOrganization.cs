...
public static class InventoryOrganization
{
  ...
  {
    foreach (KeyValuePair<string, List<string>> subcategoryIdToPermitIds in InventoryOrganization.subcategoryIdToPermitIdsMap)
    {
      string str;
      List<string> stringList;
      subcategoryIdToPermitIds.Deconstruct(ref str, ref stringList);
      string permitSubcategory = str;
      if (stringList.Contains(permit.Id))
  ...
  public static void Initialize()
  {
    ...
    foreach (KeyValuePair<string, List<string>> toSubcategoryIds in InventoryOrganization.categoryIdToSubcategoryIdsMap)
    {
      ...
      foreach (string key2 in stringList2)
      {
        ...
        if (InventoryOrganization.subcategoryIdToPermitIdsMap.TryGetValue(key2, out stringList3) && stringList3.Count != 0)
        {
          flag = false;
          break;
        }
  ...
  private static void GenerateTopLevelCategories()
  {
    ...
    InventoryOrganization.AddTopLevelCategory("JETSUITS", Assets.GetSprite((HashedString) "icon_inventory_jetsuit_helmet"), new string[4]
    {
  ...
  private static void GenerateSubcategories()
  {
    ...
    InventoryOrganization.AddSubcategory("BUILDINGS_BED_COT", Def.GetUISprite((object) "Bed").first, 200, new string[8]
    {
      "Bed_star_curtain",
      "Bed_canopy",
      "Bed_rowan_tropical",
    ...
    InventoryOrganization.AddSubcategory("BUILDING_WALLPAPER_FANCY", Assets.GetSprite((HashedString) "icon_inventory_geometric_wallpapers"), 600, new string[64 /*0x40*/]
    {
    ...
    InventoryOrganization.AddSubcategory("BUILDING_WALLPAPER_PRINTS", Assets.GetSprite((HashedString) "icon_inventory_patterned_wallpapers"), 700, new string[56]
    {
    ...
    InventoryOrganization.AddSubcategory("BUILDINGS_RECREATION", Def.GetUISprite((object) "WaterCooler").first, 700, new string[21]
    {
      "ItemPedestal_hand",
    ...
    InventoryOrganization.AddSubcategory("BUILDINGS_PRINTING_POD", Def.GetUISprite((object) "Headquarters").first, 750, new string[8]
    {
    ...
    InventoryOrganization.AddSubcategory("BUILDINGS_STORAGE", Def.GetUISprite((object) "StorageLocker").first, 800, new string[29]
    {
    ...
    InventoryOrganization.AddSubcategory("BUILDINGS_INDUSTRIAL", Def.GetUISprite((object) "RockCrusher").first, 800, new string[18]
    {
      "RockCrusher_hands",
      "RockCrusher_teeth",
    ...
    InventoryOrganization.AddSubcategory("BUILDINGS_RANCHING", Def.GetUISprite((object) "RanchStation").first, 800, new string[3]
    {
    ...
    InventoryOrganization.AddSubcategory("BUILDINGS_ELECTIC_WIRES", Def.GetUISprite((object) "Wire").first, 800, new string[13]
    {
    ...
    InventoryOrganization.AddSubcategory("CLOTHING_TOPS_BASIC", Assets.GetSprite((HashedString) "icon_inventory_basic_shirts"), 100, new string[15]
    {
      "TopStandardYellow",
      "TopStandardRed",
      "TopStandardBlue",
    ...
    InventoryOrganization.AddSubcategory("CLOTHING_TOPS_UNDERSHIRT", Assets.GetSprite((HashedString) "icon_inventory_undershirts"), 400, new string[29]
    {
    ...
    InventoryOrganization.AddSubcategory("CLOTHING_BOTTOMS_BASIC", Assets.GetSprite((HashedString) "icon_inventory_basic_pants"), 100, new string[14]
    {
      "BottomBasicBlack",
    ...
    InventoryOrganization.AddSubcategory("CLOTHING_BOTTOMS_UNDERWEAR", Assets.GetSprite((HashedString) "icon_inventory_underwear"), 300, new string[29]
    {
    ...
    InventoryOrganization.AddSubcategory("CLOTHING_GLOVES_BASIC", Assets.GetSprite((HashedString) "icon_inventory_basic_gloves"), 100, new string[20]
    {
      "GlovesStandardGold",
    ...
    InventoryOrganization.AddSubcategory("CLOTHING_GLOVES_FORMAL", Assets.GetSprite((HashedString) "icon_inventory_fancy_gloves"), 200, new string[45]
    {
      "GlovesFormalWhite",
      "GlovesLongWhite",
    ...
    InventoryOrganization.AddSubcategory("CLOTHING_GLOVES_PRINTS", Assets.GetSprite((HashedString) "icon_inventory_specialty_gloves"), 400, new string[19]
    {
      "GlovesAthlete",
      "GlovesCircuitGreen",
    ...
    InventoryOrganization.AddSubcategory("CLOTHING_SHOES_BASIC", Assets.GetSprite((HashedString) "icon_inventory_basic_shoes"), 100, new string[16 /*0x10*/]
    {
      "ShoesBasicBlack",
    ...
    InventoryOrganization.AddSubcategory("CLOTHING_SHOES_FANCY", Assets.GetSprite((HashedString) "icon_inventory_fancy_shoes"), 200, new string[12]
    {
      "ShoesBallerinaPink",
    ...
    InventoryOrganization.AddSubcategory("CLOTHING_SHOE_SOCKS", Assets.GetSprite((HashedString) "icon_inventory_socks"), 500, new string[36]
    {
    ...
    InventoryOrganization.AddSubcategory("ATMOSUIT_BODIES_BASIC", Assets.GetSprite((HashedString) "icon_inventory_atmosuit_body"), 200, new string[21]
    {
      "AtmoSuitBasicYellow",
      "AtmoSuitSparkleRed",
    ...
    InventoryOrganization.AddSubcategory("ATMOSUIT_HELMETS_BASIC", Assets.GetSprite((HashedString) "icon_inventory_atmosuit_helmet"), 100, new string[21]
    {
      "AtmoHelmetLimone",
    ...
    InventoryOrganization.AddSubcategory("ATMOSUIT_GLOVES_BASIC", Assets.GetSprite((HashedString) "icon_inventory_atmosuit_gloves"), 500, new string[20]
    {
      "AtmoGlovesLime",
    ...
    InventoryOrganization.AddSubcategory("ATMOSUIT_BELTS_BASIC", Assets.GetSprite((HashedString) "icon_inventory_atmosuit_belt"), 700, new string[20]
    {
      "AtmoBeltBasicLime",
      "AtmoBeltSparkleRed",
    ...
    InventoryOrganization.AddSubcategory("ATMOSUIT_SHOES_BASIC", Assets.GetSprite((HashedString) "icon_inventory_atmosuit_boots"), 900, new string[15]
    {
    ...
    InventoryOrganization.AddSubcategory("JETSUIT_HELMETS_BASIC", Assets.GetSprite((HashedString) "icon_inventory_jetsuit_helmet"), 1000, new string[9]
    {
    ...
    InventoryOrganization.AddSubcategory("JETSUIT_BODIES_BASIC", Assets.GetSprite((HashedString) "icon_inventory_jetsuit_body"), 1100, new string[9]
    {
    ...
    InventoryOrganization.AddSubcategory("JETSUIT_GLOVES_BASIC", Assets.GetSprite((HashedString) "icon_inventory_jetsuit_gloves"), 1200, new string[7]
    {
    ...
    InventoryOrganization.AddSubcategory("JETSUIT_SHOES_BASIC", Assets.GetSprite((HashedString) "icon_inventory_jetsuit_boots"), 1300, new string[3]
    {
