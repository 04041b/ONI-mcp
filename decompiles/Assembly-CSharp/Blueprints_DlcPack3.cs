...
public class Blueprints_DlcPack3 : BlueprintProvider
{
  ...
  {
    this.AddClothing(BlueprintProvider.ClothingType.DupeTops, PermitRarity.Universal, "permit_standard_bionic_top", "top_bionic_kanim");
    this.AddClothing(BlueprintProvider.ClothingType.DupeBottoms, PermitRarity.Universal, "permit_standard_bionic_bottom", "pants_bionic_kanim");
    this.AddClothing(BlueprintProvider.ClothingType.DupeGloves, PermitRarity.Universal, "permit_standard_bionic_gloves", "gloves_bionic_kanim");
    this.AddClothing(BlueprintProvider.ClothingType.DupeShoes, PermitRarity.Universal, "permit_standard_bionic_shoes", "shoes_bionic_kanim");
    this.AddOutfit(BlueprintProvider.OutfitType.Clothing, "permit_standard_bionic_outfit", new string[4]
    {
    ...
    this.AddBuilding("ManualGenerator", PermitRarity.Universal, "permit_generatormanual_cyberpunk", "generatormanual_cyberpunk_kanim");
    this.AddBuilding("ExobaseHeadquarters", PermitRarity.Universal, "permit_porta_pod_y_cyberpunk", "porta_pod_y_cyberpunk_kanim");
