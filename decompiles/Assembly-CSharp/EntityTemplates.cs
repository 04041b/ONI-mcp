...
public class EntityTemplates
{
    ...
    bool allowEggCrackerRecipeCreation = true)
  {
    ...
    GameObject egg = EggConfig.CreateEgg(eggId, eggName, eggDesc, (Tag) babyId, eggAnim, eggMass, eggSortOrder, base_incubation_rate, requiredDlcsOrNull, forbiddenDlcIdsOrNull, preventEggFromDroppingProducts, eggMassToDrop, allowEggCrackerRecipeCreation);
    ...
    float lethalHighTemperature = 343.15f)
  {
    ...
    KAnimFile anim1 = anim_filename != null ? Assets.GetAnim((HashedString) anim_filename) : (KAnimFile) null;
    KAnimFile anim2 = build_filename != null ? Assets.GetAnim((HashedString) build_filename) : (KAnimFile) null;
    ...
    if (symbol_override_prefix != null && (UnityEngine.Object) anim1 != (UnityEngine.Object) null)
      prefab.ApplySymbolOverridesByAffix((UnityEngine.Object) anim2 == (UnityEngine.Object) null ? anim1 : anim2, symbol_override_prefix);
