...
public class WoodGasGeneratorConfig : IBuildingConfig
{
  ...
  public override void DoPostConfigureComplete(GameObject go)
  {
    ...
    manualDeliveryKg.RequestedItemTag = (Tag) "BuildingWood";
    ...
    energyGenerator.formula = EnergyGenerator.CreateSimpleFormula((Tag) "BuildingWood", 1.2f, max_stored_input_mass, SimHashes.CarbonDioxide, 0.17f, false, new CellOffset(0, 1), 383.15f);
