...
public class SoundEvent : AnimEvent
{
  ...
  {
    return sound != null && (UnityEngine.Object) Game.Instance != (UnityEngine.Object) null && (double) Game.MainCamera.orthographicSize > (double) AudioMixer.LOW_PRIORITY_CUTOFF_DISTANCE && !AudioMixer.instance.activeNIS && GlobalAssets.IsLowPriority(sound);
  }
